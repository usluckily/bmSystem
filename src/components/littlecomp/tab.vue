...
<style scoped>
  ...
  .tab ul li{width:25%;text-align:center;margin-top: 0.5rem;}
  .tab ul li .tab_img_box{width:3rem;margin:0 auto;}
  .tab_img_box img{width:100%;display:block;}
  .tab ul li span{font-size:0.75rem;color:#666;line-height:2rem;overflow: hidden;display:block;text-overflow: ellipsis;white-space: nowrap;}
</style>
